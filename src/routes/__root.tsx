...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/logo_casa_del_disfraz.jpg", type: "image/jpeg" },
      { rel: "shortcut icon", href: "/logo_casa_del_disfraz.jpg", type: "image/jpeg" },
      { rel: "apple-touch-icon", href: "/logo_casa_del_disfraz.jpg" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="es" className="min-h-full" suppressHydrationWarning>
      <head>
        <HeadContent />
      </head>
      <body className="min-h-full overflow-x-hidden bg-[#F8FAFC] text-slate-900 font-sans antialiased" suppressHydrationWarning>
        {children}
        <Scripts />
      </body>
    </html>
