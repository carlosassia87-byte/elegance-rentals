...
export function ConfiguracionEmpresaModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl bg-[#F4F4F5] p-0 border-2 border-slate-400 shadow-2xl rounded-lg overflow-hidden text-slate-900">
        {/* Cabecera Clásica WinDev / Moderna */}
        <div className="flex items-center justify-between bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 px-5 py-3 text-white">
          <div className="flex items-center gap-2.5">
            <div className="flex h-8 w-8 items-center justify-center rounded bg-amber-500 text-slate-950 font-black shadow">
