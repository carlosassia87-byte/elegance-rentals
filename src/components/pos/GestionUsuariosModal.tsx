      ...
      <DialogContent className="max-w-4xl bg-[#F4F4F5] p-0 border-2 border-slate-400 shadow-2xl rounded-lg overflow-hidden text-slate-900">
        ...
        <div className="p-5 space-y-4 max-h-[78vh] overflow-y-auto">
          ...
          {!usuarioEditando && (
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-1.5 h-8 rounded bg-emerald-600 px-3.5 text-xs font-black text-white hover:bg-emerald-700 shadow"
              >
          ...
          {usuarioEditando && (
            <form
              ...
              className="rounded-lg border-2 border-red-400 bg-white p-4 shadow-md space-y-4 animate-in fade-in"
            >
              ...
              <div className="grid grid-cols-12 gap-3 text-xs">
                <div className="col-span-12 md:col-span-4">
                  ...
                  <input
                    ...
                    className="mt-1 h-8 w-full rounded border border-slate-400 bg-slate-50 px-2.5 font-bold text-slate-900 uppercase focus:bg-white focus:ring-1 focus:ring-red-600"
                  />
                </div>
                ...
                <div className="col-span-12 md:col-span-4">
                  ...
                  <input
                    ...
                    className="mt-1 h-8 w-full rounded border border-slate-400 bg-slate-50 px-2.5 font-black text-red-700 uppercase focus:bg-white focus:ring-1 focus:ring-red-600"
                  />
                </div>
                ...
                <div className="col-span-12 md:col-span-4">
                  ...
                  <input
                    ...
                    className="mt-1 h-8 w-full rounded border border-slate-400 bg-slate-50 px-2.5 font-bold text-slate-900 focus:bg-white focus:ring-1 focus:ring-red-600"
                  />
                </div>
                ...
                <div className="col-span-12 md:col-span-4">
                  ...
                  <select
                    ...
                    className="mt-1 h-8 w-full rounded border border-slate-400 bg-slate-50 px-2 font-black text-slate-900 uppercase focus:bg-white focus:ring-1 focus:ring-red-600"
                  >
                ...
                <div className="col-span-12 md:col-span-4 flex items-end">
                  <div className="rounded bg-slate-100 p-2 border border-slate-300 w-full text-[11px] font-semibold text-slate-600">
                    Rol: <strong className="text-red-700">{usuarioEditando.rol}</strong>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-md border border-slate-300 bg-slate-50 p-3 space-y-2">
                <h5 className="text-[11px] font-black uppercase text-slate-800 tracking-wide border-b pb-1">
                  ...
                  {[
                    ...
                    return (
                      <label
                        ...
                        className={`flex items-center gap-2 rounded border p-2 cursor-pointer transition-all select-none ${
                          activo
                            ? "bg-white border-red-500 font-bold text-slate-900 shadow-sm"
              ...
              <div className="flex justify-end gap-2 pt-2 border-t">
                <button
                  type="button"
                  onClick={() => setUsuarioEditando(null)}
                  className="h-8 rounded border border-slate-400 bg-white px-4 text-xs font-bold text-slate-700"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  disabled={guardando}
                  className="flex items-center gap-1.5 h-8 rounded bg-red-700 px-5 text-xs font-black uppercase text-white hover:bg-red-800 shadow"
                >
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-slate-800 text-white font-black uppercase text-[11px]">
                  ...
                  <th className="p-2.5">Usuario / Código</th>
                  <th className="p-2.5">Nombre Completo</th>
                  <th className="p-2.5">Rol</th>
                  <th className="p-2.5 text-center">Permisos Activos</th>
              ...
              <tbody className="divide-y divide-slate-200">
                {usuarios.map((u) => {
                  ...
                  return (
                    <tr key={u.id} className={`hover:bg-slate-50 ${esActual ? "bg-amber-50/50" : ""}`}>
                      <td className="p-2.5 font-bold text-slate-600">#{u.id}</td>
                      <td className="p-2.5 font-black text-red-700 uppercase">
                        {u.codigoUsuario}
                        {esActual && (
                          <span className="ml-1.5 text-[9px] bg-amber-600 text-white px-1.5 py-0.2 rounded font-black">
                            Tú
                          </span>
                        )}
                      </td>
                      ...
                      <td className="p-2.5">
                        <span className={`inline-flex items-center gap-1 rounded border px-2 py-0.5 text-[10px] ${getRolBadgeClass(u.rol)}`}>
                      ...
                      <td className="p-2.5 text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1 rounded text-red-600 hover:bg-red-100 disabled:opacity-30"
                          >
        ...
        <div className="flex items-center justify-between bg-slate-200 px-5 py-3 border-t border-slate-300">
          <div className="text-xs font-bold text-slate-600">
            Sesión iniciada como: <strong className="text-slate-900">{usuarioActual.nombre}</strong> ({usuarioActual.rol})
          </div>
          <button
            type="button"
            onClick={() => onOpenChange(false)}
